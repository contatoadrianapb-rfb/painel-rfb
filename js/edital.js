...
export const EDITAL_INICIAL = {
  ...
  revisado: true,
  materias: {
    "Língua Portuguesa": { dificil: false, peso: 1, topicos: [
    ...
    "Língua Inglesa": { dificil: true, peso: 1, topicos: [
    ...
    "Raciocínio Lógico": { dificil: true, peso: 1, topicos: [
    ...
    "Estatística": { dificil: true, peso: 1, topicos: [
    ...
    "Economia": { dificil: true, peso: 1, topicos: [
    ...
    "Administração Geral": { dificil: false, peso: 1, topicos: [
    ...
    "Administração Pública": { dificil: false, peso: 1, topicos: [
    ...
    "Contabilidade Geral": { dificil: true, peso: 3, topicos: [
    ...
    "Contabilidade Avançada": { dificil: true, peso: 2, topicos: [
    ...
    "Contabilidade de Custos": { dificil: true, peso: 1, topicos: [
    ...
    "Contabilidade Setor Público": { dificil: true, peso: 1, topicos: [
    ...
    "Fluência em Dados": { dificil: true, peso: 1, topicos: [
    ...
    "Auditoria": { dificil: false, peso: 1, topicos: [
    ...
    "Direito Constitucional": { dificil: false, peso: 1, topicos: [
    ...
    "Direito Administrativo": { dificil: false, peso: 2, topicos: [
    ...
    "Direito Tributário": { dificil: false, peso: 3, topicos: [
    ...
    "Legislação Tributária": { dificil: false, peso: 2, topicos: [
    ...
    "Direito Previdenciário": { dificil: false, peso: 1, topicos: [
    ...
    "Direito Financeiro": { dificil: false, peso: 1, topicos: [
    ...
    "Direito Penal Tributário": { dificil: false, peso: 1, topicos: [
    ...
    "Comércio Internacional": { dificil: false, peso: 1, topicos: [
    ...
    "Legislação Aduaneira": { dificil: false, peso: 1, topicos: [
...
export async function adicionarMateria(edital, nome, dificil = false, peso = 1) {
  if (edital.materias[nome]) throw new Error('Matéria já existe.');
  edital.materias[nome] = { dificil, peso, ativa: true, topicos: [] };
...
export function getPeso(edital, materia) {
  const m = edital.materias[materia];
  return (m && m.peso) || 1; // matérias antigas sem campo "peso" recebem peso 1 por padrão
}

export async function editarPeso(edital, materia, novoPeso) {
  if (!edital.materias[materia]) throw new Error('Matéria não encontrada.');
  edital.materias[materia].peso = novoPeso;
  return salvarEdital(edital);
}

export async function editarMateria(edital, nomeAntigo, nomeNovo, dificil, peso) {
  ...
  edital.materias[nomeNovo] = { dificil, peso: peso || dados.peso || 1, ativa: isAtiva(dados), topicos: dados.topicos };
  return salvarEdital(edital);
}
